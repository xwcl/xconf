# Used under the terms of the Python Software License https://github.com/python/cpython/blob/main/LICENSE
# This file was taken from https://github.com/python/cpython/blob/99ad742ea913e421d012c1a623029eac31bdfe85/Lib/dataclasses.py
# to enable the use of `kw_only` dataclasses without needing Python 3.10 (which was unreleased)
import re
import sys
import copy
import types
...
import functools
import abc
## monkeypatch from https://github.com/python/cpython/commit/bef7d299eb911086ea5a7ccf7a9da337e38a8491
def update_abstractmethods(cls):
    ...
    return cls
abc.update_abstractmethods = update_abstractmethods
##
import _thread
